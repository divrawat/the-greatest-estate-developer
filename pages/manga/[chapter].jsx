...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Read ${MANGA_NAME} chapter ${chapterNumber} online. It follows the journey of a visionary protagonist who rises to prominence in the cutthroat world of real estate development. Driven by ambition and a keen business acumen, they navigate through challenges and rivalries, aiming to build the most impressive estates and reshape the skyline of their city.`
